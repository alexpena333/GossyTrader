...
# Ensure the 'data' directory exists at the root level to prevent 'unable to open database file' errors
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
DATA_DIR = os.path.join(BASE_DIR, "data")
os.makedirs(DATA_DIR, exist_ok=True)

# Point SQLAlchemy directly to the absolute path of tridding.db inside data/
SQLALCHEMY_DATABASE_URL = f"sqlite:///{os.path.join(DATA_DIR, 'tridding.db')}"
